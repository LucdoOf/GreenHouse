...
return [
    ...
    'configuration.typeFlats.create' => ["POST", "/configuration/typeFlats/create", [ConfigurationController::class, "createFlatType"]],
    'configuration.typeRooms.create' => ["POST", "/configuration/typeRooms/create", [ConfigurationController::class, "createRoomType"]],
    'configuration.linkedTypeRooms.create' => ["POST", "/configuration/typeFlats/(.+)/create", [ConfigurationController::class, "createLinkedTypeRooms"]],
